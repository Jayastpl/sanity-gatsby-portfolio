...
const SearchBrandInput = React.forwardRef((props, ref) => {
       ...
       if (props.document.content && props.document.content.hasOwnProperty('country') ) {
      ...
      useEffect(() => {
       ...
       useEffect(() => {
        const BRAND_URL = ((process.env.SANITY_STUDIO_API_DATASET == 'production')? configSetting.productionApiUrl.getBrandUrl : configSetting.StagingApiUrl.getBrandUrl  )  + countryName;
